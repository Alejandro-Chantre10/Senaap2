...
<body class="antialiased">
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0A2A55;">
            <div class="container-fluid">
                ...
                <a class="navbar-brand text-light text-decoration-none logopa" href="#"
                    style="font-size: 30px;">SENAPP</a>
    ...
    <div>
        <p class="contenido text-center border text-light">Facilita la visualización<br>de información</p>
    </div>
    ...
    <div id="SobreNosotros" class="container-fluid">
        <div class="row">
            <div class="col-7">
                <h3 style="padding: 0px 130px;"">¿QUE ES SENAPP?</h3>
        <p style=" padding: 0px 130px;">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
